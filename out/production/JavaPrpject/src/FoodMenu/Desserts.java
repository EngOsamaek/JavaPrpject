...
public class Desserts extends Menu {
    ...
    public void SetMenu () {
        ...
        namemeal.setLayoutY(230);

        nametxt.setLayoutX(14);
        nametxt.setLayoutY(245);


        description.setLayoutX(14);
        description.setLayoutY(260);

        desctxt.setLayoutX(14);
        desctxt.setLayoutY(275);



      Price.setLayoutX(235);
        Price.setLayoutY(3325);


        pricetxt.setLayoutX(14);
        pricetxt.setLayoutY(377);


        calories.setLayoutX(14);
        calories.setLayoutY(355);


        caloriestxt.setLayoutX(14);
        caloriestxt.setLayoutY(370);
        ...
        button.setOnAction((ActionEvent e) -> {
            try {
                if (textField.getText().isEmpty() || textField.getText() == null){
                    ...
                    File file = new File("src/FoodMenu/Desserts.txt");
        ...
        edit.setOnAction((ActionEvent r) -> {
            try {
                ...
                if (nametxt.getText().isEmpty() || desctxt.getText().isEmpty() || pricetxt.getText().isEmpty() || caloriestxt.getText().isEmpty() || nametxt.getText()==null || desctxt.getText()==null || pricetxt.getText()==null||caloriestxt.getText()==null) {
